...
const UpCommingMovie = () => {
    ...
    const getMovie = async() => {
        const respon = await axios.get("https://api.themoviedb.org/3/movie/now_playing?api_key=6dcaf0667fe77633ed4db188ddc50fa2&language=en-US&page=1&region=ID")
  ...
  return (
    <>
    <Text style={{fontSize:26, fontWeight:'700', marginVertical:10, marginLeft:10}}>Upcomming Movie</Text>
